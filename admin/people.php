...
class CkEditor extends Common
{
    ...
    protected function initiateEditor()
    {
        ...
        $tableColumns['caracteristica1'] = array(
            'display_text' => 'Dato 1', 
            'perms' => 'EVCTAXQSHO',
            'req' => true
        );
        $tableColumns['caracteristica2'] = array(
            'display_text' => 'Dato 2', 
            'perms' => 'EVCTAXQSHO',
            'req' => true
        );
        $tableColumns['caracteristica3'] = array(
            'display_text' => 'Dato 3', 
            'perms' => 'EVCTAXQSHO',
            'req' => true
        );
        ...
        $tableColumns['facebook'] = array(
            'display_text' => 'Facebok', 
            'perms' => 'EVCTAXQSHO'
             
        );
        $tableColumns['twitter'] = array(
            'display_text' => 'Facebok', 
            'perms' => 'EVCTAXQSHO'
             
        );
        $tableColumns['google'] = array(
            'display_text' => 'Google+', 
            'perms' => 'EVCTAXQSHO'
        ...
        $this->Editor->setConfig('tableTitle','Personas');
        $this->Editor->setConfig('addRowTitle','Nueva Persona');
        $this->Editor->setConfig('editRowTitle','Editar Persona');
