...
private function desencriptar($cadena){
	...
	public function create($nombre,$perfil,$email,$password,$permiso,$region,$estado )
	{
		try
		{
			$stmt = $this->db->prepare("INSERT INTO usuarios(nombre,perfil,email,
													password,permiso,region,estado)
	...
	public function update($id,$nombre,$perfil,$email,$password,$perfil,$region,$estado)
	{
		try
		{
